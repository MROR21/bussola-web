...
export function JornadaView({
  ...
  if (podeEntrar) {
    ...
    return (
      <div className="anim-fade relative flex w-full max-w-2xl flex-col gap-5">
        ...
        <MapIllustration className="pointer-events-none absolute -bottom-10 -left-8 w-56 text-gold-500 opacity-[0.15]" />
        <button
          type="button"
          onClick={sairFase}
  ...
  return (
    <div className="relative flex w-full max-w-2xl flex-col gap-8">
      ...
      />
      <MapIllustration
        className="pointer-events-none absolute -bottom-10 -left-20 w-[420px] text-gold-500 opacity-[0.15]"
      />
